...
class Auditor:
    ...
    def __init__(self, X_prime, y, fairness_def):
        ...
        # X_prime_0 : all sensitive attributes for points such that y=0 (FP) or y=1 (FN)
    ...
    #returns X_prime_0 with 'corrected' labels
    ...
    def get_group(self, predictions, metric_baseline):
        ...
        """
        # metric baseline: current overall FPR
